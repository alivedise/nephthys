...
(function(exports) {
  ...
  ScaleToolBar.prototype.template = function() {
    return '<div class="btn-group" id="scaleToolbar">' +
              '<button type="button" id="scaler" class="btn btn-default"><span class="glyphicon glyphicon-off" id="reset-scale"></span> <span id="scaleText">100%</span></button>' +
              '<button type="button" id="zoomInButton" class="btn btn-default"><span class="glyphicon glyphicon-plus"></span></button>' +
              '<button type="button" id="zoomOutButton" class="btn btn-default"><span class="glyphicon glyphicon-minus"></span></button>' +
            '</div>';
  };
